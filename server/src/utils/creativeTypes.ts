// 创意模式数据类型 - 与前端 types/creative.ts 保持一致
...
export type GoldEffectId =
  | 'gold_plus3' | 'gold_plus6' | 'gold_plus10' | 'gold_next_double' | 'gold_free_card'
  | 'gold_extra_turn' | 'gold_score_shield' | 'gold_global_bonus' | 'gold_purple_upgrade' | 'gold_territory';

export type PurpleEffectId =
  | 'purple_plus5' | 'purple_plus2' | 'purple_minus3' | 'purple_minus1' | 'purple_minus10'
  | 'purple_next_double' | 'purple_skip' | 'purple_free_card' | 'purple_time5s' | 'purple_nothing'
  | 'purple_score_swap' | 'purple_score_average' | 'purple_remove_piece';

export type RedEffectId =
  | 'red_minus3' | 'red_minus5' | 'red_minus10' | 'red_skip' | 'red_time5s' | 'red_remove_piece'
  | 'red_half_score' | 'red_undo_last' | 'red_big_piece_ban' | 'red_total_08';
...
export type ItemCardId =
  | 'item_blackhole' | 'item_shrink' | 'item_curse' | 'item_steel' | 'item_freeze'
  | 'item_pressure' | 'item_plunder' | 'item_blame';
...
export type StatusEffectType =
  | 'next_double' | 'score_shield' | 'skip_turn' | 'time_pressure' | 'half_score'
  | 'big_piece_ban' | 'steel' | 'purple_upgrade' | 'chain_piece_size';
