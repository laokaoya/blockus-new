export const en = {
  ...
  common: {
    ...
    loadingTimeoutHint: 'Please check your connection or go back to retry',
  ...
  game: {
    ...
    pausedVisibility: 'You left the game',
    pausedVisibilityDesc: 'Tap to continue',
    forceBack: 'Back to Lobby',
    restart: 'Restart',
    quit: 'Quit Game',
    endGame: 'End Game',
    gameOver: 'Game Over',
  ...
  settings: {
    ...
    strategyExpansionist: 'Expansionist',
    strategyBlocker: 'Blocker',
    strategyConservative: 'Conservative',
    strategyGapMinimizer: 'Gap Minimizer',
    strategyHunter: 'Hunter',
    easy: 'Easy',
    medium: 'Medium',
    hard: 'Hard',
